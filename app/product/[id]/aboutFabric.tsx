  ...
  return (
    <div>
        ...
        <div className="flex gap-2 mt-5">
          <Image src="/images/about_fabric/fabric11.webp" alt="fabric 1" width={700} height={700} className="w-3/5 sm:w-1/2 md:w-1/2 h-auto object-contain" />
        ...
        <div className="flex gap-2 mt-5">
        <Image src="/images/about_fabric/fabric2.webp" alt="fabric 1" width={700} height={700} className="w-3/5 sm:w-1/2 h-auto object-contain -ml-4" />
