  ...
  return (
     <div className="flex gap-20 px-32">
        <div className="max-w-52 flex flex-col justify-between  py-5">
            ...
            <Button variant="link" className="w-fit text-green-800 justify-start ">discover more <MoveRight/></Button>
            {/* <Link href={"#"} className="flex gap-2 align-center">expolore the diary <MoveRight/> </Link> */}
        </div>
        <Image src="/images/featured_collection.png" alt="lookbook" width={500} height={200} className="flex-1 h-72 object-cover" />
    </div>
  )
}
