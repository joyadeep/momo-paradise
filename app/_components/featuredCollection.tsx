...
const FeaturedCollection = () => {
  return (
     <div className="flex gap-20 px-2 lg:px-32">
        ...
        <Image src="/images/featured_collection.png" alt="lookbook" width={500} height={200} className="flex-1 h-72 md:w-full overflow-hidden object-cover hidden md:block" />
    </div>
  )
}
