...
const LookBook = () => {
  return (
    <div className="flex gap-20 px-2 lg:px-32 bg-pink-100 my-2">
        ...
        <Image src="/images/lookbook.png" alt="lookbook" width={500} height={200} className="flex-1 h-72 md:w-full object-cover overflow-hidden hidden md:block" />
    </div>
  )
}
