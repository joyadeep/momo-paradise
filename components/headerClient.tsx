...
const HeaderClient = ({cart}:HeaderProps) => {
  ...
  return (
    <div className="relative z-40">
        ...
        <div className="bg-white w-full max-w-400 mx-auto flex justify-between items-center px-2 md:px-10 py-3"> 
        <Sheet >
        ...
        <div className="flex gap-3 items-center md:gap-7 2xl:gap-14 text-xs text-green-800">
           <Search size={22} strokeWidth={1.5} onClick={() => setIsSearchOpen(true)} className="cursor-pointer"/>
            <AuthNav/>
